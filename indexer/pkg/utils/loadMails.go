...
func CreateJson(url string, nameOput string, nameIndex string) *[]byte {
...
func LoadMails(url string, nameOput string, nameIndex string) {
	b := CreateJson(url, nameOput, nameIndex)
